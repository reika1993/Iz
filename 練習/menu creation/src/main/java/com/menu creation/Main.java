        ...
        switch (cat1) {
            case ("和食"):
                ...
                if (sta1 == ("ご飯")) {
                    ...
                    System.out.println("主食は" + sta1 + "、主菜は" + main1.get(1) + "、副菜は" + side1.get(1) + "と" + side2.get(1) + "はいかがですか。");
                } else {
                    ...
                    System.out.println("主食は" + sta1 + "、副菜は" + side3.get(1) + "と" + side4.get(1) + "はいかがですか。");
                }
                break;
            ...
            case ("洋食"):
                ...
                System.out.println("主食は" + staple2.get(1) + "、副菜は" + side5.get(1) + "、乳製品は" + dairy.get(1) + "はいかがですか。");
                break;
            ...
            case ("中華"):
                ...
                System.out.println("主食は" + staple3.get(1) + "、副菜は" + side6.get(1) + "と" + side7.get(1) + "はいかがですか。");
                break;
